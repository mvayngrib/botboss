...
Bot.prototype.init = function (handler) {
...
Bot.prototype.install = function (plugin) {
...
Bot.prototype.runinit = co(function* (opts) {
  const handlers = this._inithandlers.slice()
...
/**
 * export a function for which a blank session will be created
 * @param  {String}   name
 * @param  {Function} fn
 * @return {Bot}
 */
Bot.prototype.export = function (name, fn) {
